# Generated by Django 4.0.10 on 2023-04-25 16:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entries', models.ManyToManyField(blank=True, through='core.Entry', to='core.album')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='users_lists', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='entry',
        ...
        migrations.AddConstraint(
            model_name='entry',
            constraint=models.UniqueConstraint(fields=('order', 'list'), name='unique_order_for_list'),
        ),
    ]
